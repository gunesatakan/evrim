...
SETTINGS_SCHEMA = {
        ...
        ("BASE_TUMBLE_RATE",      "Temel dönme sıklığı"),
        ("TUMBLE_GAIN_POSITIVE",  "Koku artarken dönmeyi ne kadar azaltsın"),
        ("TUMBLE_GAIN_NEGATIVE",  "Koku azalırken dönmeyi ne kadar artırsın"),
        ("TUMBLE_RATE_MIN",       "En düşük dönme sıklığı"),
        ("TUMBLE_RATE_MAX",       "En yüksek dönme sıklığı"),
        ("LEVY_ALPHA",            "Koku yokken arama deseni (düşük = uzun atılımlar)"),
