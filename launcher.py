...
SETTINGS_SCHEMA = {
        ...
        ("ISIK_YONLULUK",           "Isigin aydinlik taraftan gelen payi: isiga bakan goz x(1+bu), arkasi donuk goz x(1-bu) okur"),
        ("ISIK_GURULTU",            "Foton gurultusu: taban goz tam isikta saniyede 1/bu foton sayar"),
        ("ISIK_PENCERE",            "Tek gozun isigi karsilastirdigi pencere (sn)"),
        ("ISIK_UZAMSAL_MIN",        "Gozler arasi fark ortalamanin bu oranindan kucukse yon okunmaz"),
